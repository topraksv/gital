/** What a list's or an item's name and face are, apart from where they are stored or drawn. */

/** Long enough for "Haftalık market — Kadıköy", short enough to stay on a card or a row. */
export const NAME_MAX = 60;

/**
 * What a typed list or item name is stored as: whitespace runs folded to one space, ends
 ...
 */
export function nameFrom(input: string): string | null {
